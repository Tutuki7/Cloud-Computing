...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateUser = channel.unary_unary(
                ...
                request_serializer=users__pb2.ValidateUserRequest.SerializeToString,
                response_deserializer=users__pb2.ValidateUserResponse.FromString,
                _registered_method=True)
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ValidateUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=users__pb2.ValidateUserRequest.FromString,
                    response_serializer=users__pb2.ValidateUserResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def ValidateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserService/ValidateUser',
            users__pb2.ValidateUserRequest.SerializeToString,
            users__pb2.ValidateUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
