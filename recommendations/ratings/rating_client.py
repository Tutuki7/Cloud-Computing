...
from . import rating_pb2 as rating_pb2, rating_pb2_grpc as rating_pb2_grpc
from dotenv import load_dotenv
import os

load_dotenv()
GRPC_URL = os.getenv("REVIEW_GRPC_URL")
...
class ReviewGrpcClient: # 
    def __init__(self, target: str = GRPC_URL) -> None:
        ...
        self._stub: Optional[rating_pb2_grpc.ReviewServiceStub] = None

    async def start(self) -> None:
        if self._channel is not None:
            return
        self._channel = grpc.aio.insecure_channel(self._target)
        self._stub = rating_pb2_grpc.ReviewServiceStub(self._channel)
    ...
    def _require_stub(self) -> rating_pb2_grpc.ReviewServiceStub:
